    ...
    <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="flex flex-col items-center justify-center gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  AI is reviewing your students, workouts, and performance metrics...
                </p>
              </div>
            </div>
          </CardContent>
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>
            • Suggestions are generated by analyzing your students' workout completion rates,
          ...
          <p>
            • The AI sees anonymized data about workout types, completion rates, and student
            engagement patterns
          </p>
        </CardContent>
      </Card>
