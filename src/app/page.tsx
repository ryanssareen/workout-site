          ...
          <div className="container mx-auto px-4 py-16 md:py-24 lg:py-32">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto">
                Plan workouts, track completion, sync with Strava, and send automated reminders. All in one place.
              </p>

              <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
                <Button asChild size="lg" className="h-11 px-6 shadow-xl shadow-primary/25">
                  <Link href="/register">
                ...
                {sports.map((sport, i) => {
                  ...
                  return (
                    <div key={i} className="flex flex-col items-center gap-2">
                      <div className={`p-3 rounded-xl ${sport.color} shadow-lg`}>
                        <Icon className="h-5 w-5 text-white" />
                      </div>
                      <span className="text-xs font-medium text-muted-foreground">{sport.name}</span>
                    </div>
                  );
                })}
              </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              {steps.map((step, i) => {
                ...
                return (
                  <Card key={i} className="relative p-6 text-center bg-card/50 backdrop-blur border-border/50 hover:shadow-lg transition-shadow">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
              {features.map((feature, i) => {
                ...
                return (
                  <Card key={i} className="p-5 bg-card/50 backdrop-blur border-border/50 hover:shadow-lg hover:border-primary/20 transition-all group">
                    <div className="mb-3">
                      <div className="inline-flex p-2.5 rounded-xl bg-gradient-to-br from-primary to-primary/80 text-primary-foreground shadow-lg shadow-primary/20 group-hover:scale-110 transition-transform">
              ...
              <div className="grid md:grid-cols-2 gap-10 items-center">
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Connect Strava once and your activities sync automatically. No manual entry needed.
                  </p>
                  <ul className="space-y-2">
                    {['One-click connection', 'Auto-sync all activities', 'See pace, distance, duration', 'Match to planned workouts'].map((item, i) => (
        ...
        <section className="py-16 md:py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-2xl mx-auto text-center space-y-6">
              ...
              <Button asChild size="lg" className="h-11 px-8 shadow-xl shadow-primary/25">
                <Link href="/register">
