  ...
  return (
    <div>
      ...
      <div
        ...
        className="bg-gradient-to-br from-red-50/50 via-white to-white dark:from-[#0a0a0f] dark:via-[#0d0d14] dark:to-[#0b0b10] text-slate-900 dark:text-slate-100 p-8 rounded-2xl border border-red-100/60 dark:border-red-900/40 shadow-[0_20px_80px_-50px_rgba(239,68,68,0.5)] print:shadow-none print:border-0"
      >
        {/* Header with The Daily Athlete Branding */}
        <div className="border-b-2 border-primary pb-6 mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="h-12 w-12 rounded-xl bg-foreground flex items-center justify-center shadow-lg shadow-foreground/20">
